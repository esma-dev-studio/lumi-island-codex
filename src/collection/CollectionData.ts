...
export const COLLECTION_ENTRIES: CollectionEntry[] = [
  ...
  { id: "lantern-goby", category: "fish", name: "ちょうちんハゼ", reading: "ちょうちん はぜ", description: "おなかの光で 海の道をてらす。", place: "海辺の釣りデッキ", timeHint: "いつでも", visual: "fish", colors: ["#f0b85b", "#315f71"] },
  { id: "glass-ray", category: "fish", name: "ガラスエイ", reading: "がらす えい", description: "すきとおる ひれで ゆっくり泳ぐ。", place: "海辺の釣りデッキ", timeHint: "夕方と夜", visual: "fish", colors: ["#9fd9df", "#657ba5"] },
  ...
  { id: "starleaf-islet", category: "plant", name: "星しずく草", reading: "ほししずく そう", description: "小島の風で 葉がきらめく。", place: placeHint("starleaf"), timeHint: "いつでも", visual: "leaf", colors: ["#8cc7a8", "#f3db83"] },
  { id: "moonpetal-night", category: "plant", name: "月あかり花", reading: "つきあかり ばな", description: "夜だけ 月みたいにひらく。", place: placeHint("moonpetal"), timeHint: "夜だけ", visual: "leaf", colors: ["#bca7ef", "#f2e8ff"] },
  { id: "stardew-night", category: "plant", name: "星つゆ草", reading: "ほしつゆ そう", description: "夜つゆを 小さく光らせる。", place: placeHint("stardew"), timeHint: "夜だけ", visual: "reed", colors: ["#77cddd", "#dff9ff"] },
